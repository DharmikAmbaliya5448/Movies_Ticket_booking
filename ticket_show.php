...
<div class="card ">
                ...
                ?>
                    ...
                    <tr>
                    <td></td>
<td style="padding: 1px 2px 1px 155px;">Date: <?php echo date("j M, Y", strtotime($row['payment_date']));?></td>
...
<td style="padding: 12px 2px 12px 60px">
    <?php echo date("j M, Y", strtotime($row['booking_date']));?>
</td>
...
<a href="logout.php"><button class="form-control btn">Logout</button></a>
</body>
</html>