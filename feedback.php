              ...
              <form onsubmit="return feedbackvalidate();">
                ...
                <div class="row">
                  <div class="col-md-6 form-group">
                    <input type="text" class="form-control" name="feedbackname" id="feedbackname" placeholder="First name" autocomplete="off">
                ...
                <div class="row">
                  <div class="col-md-12 form-group">
                    <input type="text" class="form-control" name="feedbackemail" id="feedbackemail" placeholder="Email" autocomplete="off"><div id="emailerror"></div>
                  </div>
                </div>

                <div class="row">
                  <div class="col-md-12 form-group">
                    <textarea class="form-control" name="feedbackmassage" id="feedbackmassage" cols="30" rows="7" placeholder="Write your message" autocomplete="off"></textarea>
...
<div class="col-lg-12">
            <div class="form-group">
                     <button type="button" data-toggle="modal" data-target="#tailer_modal" class="btn btn-dark"><font style="color:white;">Send Feedback</font></button>
                  </div>
    </div>
