    ...
    ?>
          ...
          <div class="col-lg-3 col-md-3 col-sm-6">
            <div class="running-movie">
             <img src=./new-admin/assets/movie_images/<?php echo $row['image']; ?> alt="" class="image-resize2" style="width: 100%;">
              <div class="top-right">
...
?>
      ...
      <div class="container">
        <a href="allmovie.php">
<img src="img/stream.jpg" alt=""  style="width: 100%; height: 120px; margin:20px 0"></a>
</div>
<div class="container">
    ...
    ?>
        <div class="image-box">
          <div class="col-lg-2 col-md-3 col-sm-6">
            ...
            <div class="card" style="width: 12rem;margin-top:25px;">
               <img class="card-img-top image-resize4" src="./new-admin/assets/movie_images/<?php echo $row['image']; ?> " alt="Card image cap">
...
<!-- <div class="quote-box">
        ...
        <div>
            ...
            <button onclick="tweet()"><img src="./image/tweeter.jpg" alt="">Tweet</button>
        </div>
    </div> -->
