                    ...
                    <div class="tab-content">
                        <div class="row">
                           ...
                           if (mysqli_num_rows($result) > 0) {
                                ...
                                Payment Date: '.date("j M, Y ",strtotime('today')).'
                                </div>
                            <div class="col-lg-6">
                                ...
                                Time: '.$_POST['show'].'<br>
                                Booking Date: '.date("j M, Y",strtotime('today')).'
                        ...
                        <div id="credit-card" class="tab-pane fade show active pt-3">
                                ...
                                <div class="form-group"> <label for="username">
                                        <h6>Card Owner</h6>
                                    </label> <input type="text" id="card_name" name="card_name" placeholder="Card Owner Name" class="form-control" autocomplete="off"> 
                                    <div id="validatecardname"></div>
                                </div>
                                <div class="form-group"> <label for="cardNumber">
                                        <h6>Card number</h6>
                                    </label>
                                    <div class="input-group"> <input type="text" id="card_number" name="card_number" placeholder="Valid card number" class="form-control" minlength="12" required> 
                                     </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="form-group"> <label><span class="hidden-xs">
                                            ...
                                            <label for="ex_date"><span><input type="date" id="ex_date" placeholder="MM" name="ex_date" class="form-control" min="<?php echo date('Y-m-d'); ?>"></span></label>
                                            </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-4"> <label data-toggle="tooltip" title="Three digit CV code on the back of your card">
                                                <h6>CVV </h6>
                                            </label> <input type="number" id="cvv" class="form-control" minlength="3" required> </div>
