...
<?php
    ...
    <div class="row feature design">
        <div class="col-lg-5"> <img src="./new-admin/assets/movie_images/<?php echo $row['image']; ?>" class="resize-detail" alt="" width="100%"> </div>
      <div class="col-lg-7">
        ...
        <table class="content-table">
          ...
          <tr>
            <td>Trailer</td><td><a data-toggle="modal" data-target="#tailer_modal<?php echo $row['id'];?>">Veiw Tailer</a></td>
  ...
  <div class="modal-dialog" role="document">
    ...
    <!-- <div class="description">
      <h4 style="color: #cb09de;">Description</h4>
      <p>
