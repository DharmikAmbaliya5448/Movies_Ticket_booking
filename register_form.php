...
<body>
  ...
  <div class="container">
    <center><a href="index.php"><img src="img/logo.jpg" alt="" style="margin-top: 80px; width: 50%;"></a></center>
      ...
      <form id="form" action="register.php" method="post" enctype="multipart/form-data" onsubmit="return validate();">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="tel" id="number" name="number" placeholder="Enter your Phone Number" autocomplete="off">
          	<p id="numbererror"></p>
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="password" id="cpassword" name="cpassword" placeholder="Confirm your password" autocomplete="off">
        ...
        <div class="button">
          If You have already register then login!!!<a href="login_form.php">
